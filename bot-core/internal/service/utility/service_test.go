...
func TestStartAndHelpCommandsRenderPolishedUX(t *testing.T) {
	...
	assertButton(t, helpMarkup, 9, 1, "⭐ Custom Instances", "ux:help:custominstances", "")
	assertButton(t, helpMarkup, 10, 0, "AntiAbuse", "ux:help:antiabuse", "")
	assertButton(t, helpMarkup, 10, 1, "Bio Links", "ux:help:biolinks", "")
